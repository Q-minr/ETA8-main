  ...
  <div class="HorizontallForm">
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col class="subject-info" :span="12" :xs="24">
          <el-form-item label="买方大洲" prop="BuyerContinent">
            <el-input v-model="BuyerContinent" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col class="subject-info" :span="12" :xs="24">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        BuyerProvince: [
          { required: true, message: "请选择买方省份", trigger: "blur" },
        ],
        BuyerCity: [
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          data2upload.append("BuyerContinent", this.FormData.BuyerContinent);
